...
public:
    ...
    void cap_raw_upcoming_temperature();
    virtual bool temperature_can_increase() const;
    virtual bool temperature_can_decrease() const;
    void change_temperature(float degree);
    void temperature_decay();
    uint8_t get_current_temperature_level() const;
    uint8_t get_upcoming_temperature_level() const;
    bool temperature_reached_level (uint8_t level) const;
    bool temperature_fell_below_level (uint8_t level) const;
    virtual bool has_temperature_effects() const;
    bool temperature_effect_is_active (uint8_t effect) const;
    bool temperature_effect_is_activating (uint8_t effect) const;
    bool temperature_effect_is_deactivating (uint8_t effect) const;
