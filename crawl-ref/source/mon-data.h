...

{
    ...
    MR_VUL_POISON,
    300, 6, MONS_SPIDER, MONS_JUMPING_SPIDER, MH_NATURAL, -2,
...

{
    ...
    MR_VUL_POISON,
    240, 4, MONS_SPIDER, MONS_TRAPDOOR_SPIDER, MH_NATURAL, -2,
...

{
    ...
    M_NO_SKELETON | M_WEB_SENSE,
    MR_VUL_POISON,
    130, 4, MONS_SPIDER, MONS_REDBACK, MH_NATURAL, -2,
...

{
    ...
    { 13, 3, 5, 0 },
    8, 10, MST_NO_SPELLS, CE_MUTAGEN, Z_NOZOMBIE, S_SILENT,
    I_INSECT, HT_LAND, FL_WINGED, 12, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_LARGE
},
...
{
    MONS_BLACK_EYE, 'G', MAGENTA, "black eye",
    M_NO_SKELETON | M_SPELLCASTER | M_SEE_INVIS | M_GLOWS_LIGHT,
    MR_RES_ASPHYX,
    0, 14, MONS_GIANT_EYEBALL, MONS_BLACK_EYE, MH_NATURAL, MAG_IMMUNE,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 10, 3, 5, 0 },
    3, 1, MST_BLACK_EYE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_PLANT, HT_LAND, FL_LEVITATE, 7, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_MEDIUM
},
// hybrids ('H')
...

{
    ...
    { {AT_BITE, AF_PLAIN, 45}, {AT_ENGULF, AF_PLAIN, 35}, AT_NO_ATK, AT_NO_ATK },
    { 16, 3, 5, 0 },
...

{
    ...
    { {AT_CONSTRICT, AF_CRUSH, 2}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 18, 0, 1, 10 },
