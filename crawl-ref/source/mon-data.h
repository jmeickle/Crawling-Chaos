...

{
    ...
    { 5, 3, 5, 0 },
    6, 13, MST_NO_SPELLS, CE_POISON_CONTAM, Z_NOZOMBIE, S_BARK,
    I_ANIMAL, HT_LAND, FL_NONE, 15, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_MEDIUM
},
...

{
    ...
    M_SPECIAL_ABILITY | M_WARM_BLOOD | M_FAKE_SPELLS,
    MR_RES_FIRE,
...

{
    ...
    0, 15, MONS_INSUBSTANTIAL_WISP, MONS_INSUBSTANTIAL_WISP, MH_NONLIVING, MAG_IMMUNE,
...

{
    ...
    { {AT_BITE, AF_DISEASE, 5}, {AT_BITE, AF_VAMPIRIC, 8}, AT_NO_ATK, AT_NO_ATK },
    { 5, 3, 5, 0 },
...

{
    ...
    MR_NO_FLAGS,
    2500, 12, MONS_HILL_GIANT, MONS_ETTIN, MH_NATURAL, -3,
...

{
    ...
    I_ANIMAL, HT_LAND, FL_FLY, 9, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_HUGE
},
...

{
    ...
    { 18, 4, 5, 0 },
    10, 15, MST_PEARL_DRAGON, CE_CLEAN, Z_NOZOMBIE, S_ROAR,
    I_ANIMAL, HT_LAND, FL_FLY, 13, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_GIANT
},
...

{
    ...
    I_NORMAL, HT_LAND, FL_FLY, 19, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { 13, 6, 5, 0 },
    2, 10, MST_SHEDU, CE_CLEAN, Z_NOZOMBIE, S_SCREECH,
    I_NORMAL, HT_LAND, FL_FLY, 19, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_MEDIUM
},
...

{
    ...
    MR_RES_POISON | MR_RES_ASPHYX | MR_RES_ACID,
    0, 14, MONS_JELLY, MONS_ACID_BLOB, MH_NATURAL, -7,
...

{
    ...
    // if we decide to allow this for normal games, please remove M_NO_POLY_TO
    M_SPECIAL_ABILITY | M_STATIONARY | M_SEE_INVIS | M_NO_POLY_TO,
...

{
    ...
    MR_NO_FLAGS,
    0, 23, MONS_ORB_GUARDIAN, MONS_ORB_GUARDIAN, MH_NATURAL, -6,
    { {AT_HIT, AF_PLAIN, 45}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 15, 3, 5, 0 },
...
{   // with randomised stats
    ...
    { {AT_BITE, AF_PLAIN, 28}, {AT_TRAMPLE, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK },
    { 7, 9, 6, 0 },
...

{
    ...
    M_SPELLCASTER | M_SEE_INVIS | M_GLOWS_LIGHT,
    MR_RES_POISON | MR_VUL_FIRE | mrd(MR_RES_COLD, 3),
    0, 15, MONS_FIEND, MONS_ICE_FIEND, MH_DEMONIC, -12,
...

{
    ...
    0, 14, MONS_FIEND, MONS_SHADOW_FIEND, MH_DEMONIC, -13,
    ...
    I_HIGH, HT_LAND, FL_LEVITATE, 9, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_LARGE
},

{
    ...
    0, 25, MONS_FIEND, MONS_PIT_FIEND, MH_DEMONIC, -12,
...

{
    ...
    0, 12, MONS_CLAY_GOLEM, MONS_ELECTRIC_GOLEM, MH_NONLIVING, -8,
...

{
    ...
    I_HIGH, HT_LAND, FL_LEVITATE, 11, MOVE_ENERGY(20),
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_TINY
},
...
// Swarms. Each swarm is a valid monster which is
// generated in 'limbo' and tied to a cloud. Their
// stats do actually affect the cloud!
{
    MONS_SWARM_BEES, 'k', BROWN, "bees",
    M_NO_EXP_GAIN | M_NO_SKELETON,
    MR_VUL_POISON,
    0, 10, MONS_KILLER_BEE, MONS_SWARM_BEES, MH_NATURAL, -3,
    { {AT_STING, AF_POISON, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 1, 0, 0, 1 },
    2, 18, MST_NO_SPELLS, CE_POISONOUS, Z_SMALL, S_BUZZ,
    I_INSECT, HT_LAND, FL_FLY, 20, DEFAULT_ENERGY,
...
{
    MONS_SWARM_BUTTERFLIES, 'b', BLACK, "butterflies",
    M_NO_SKELETON | M_CONFUSED | M_NO_EXP_GAIN,
    MR_VUL_POISON,
    0, 10, MONS_BUTTERFLY, MONS_SWARM_BUTTERFLIES, MH_NATURAL, -3,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 1, 0, 0, 1 },
    0, 25, MST_NO_SPELLS, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_INSECT, HT_LAND, FL_FLY, 25, DEFAULT_ENERGY,
...
{
    MONS_SWARM_SPARKS, '*', LIGHTCYAN, "sparks",
    M_NO_EXP_GAIN | M_CONFUSED | M_INSUBSTANTIAL | M_GLOWS_LIGHT,
    mrd(MR_RES_ELEC | MR_RES_POISON | MR_RES_FIRE | MR_RES_COLD, 3),
    0, 20, MONS_BALL_LIGHTNING, MONS_SWARM_SPARKS, MH_NONLIVING, MAG_IMMUNE,
    { {AT_HIT, AF_ELEC, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 1, 0, 0, 1 },
    0, 10, MST_NO_SPELLS, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_PLANT, HT_LAND, FL_LEVITATE, 20, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_TINY
...
{
    MONS_SWARM_SPIDERS, 's', CYAN, "spiders",
    M_NO_EXP_GAIN | M_NO_SKELETON,
    MR_VUL_POISON,
    250, 10, MONS_SPIDER, MONS_SWARM_SPIDERS, MH_NATURAL, -3,
    { {AT_BITE, AF_POISON_MEDIUM, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 1, 0, 0, 1 },
    3, 10, MST_NO_SPELLS, CE_POISON_CONTAM, Z_SMALL, S_HISS,
    I_INSECT, HT_LAND, FL_NONE, 15, DEFAULT_ENERGY,
...
// "J"ellies.
{
    ...
    M_SENSE_INVIS | M_SPECIAL_ABILITY | M_ACID_SPLASH | M_NO_REGEN
        | M_UNIQUE,
    MR_RES_POISON | MR_RES_ASPHYX | MR_RES_ACID,
    0, 25, MONS_JELLY, MONS_JELLY, MH_NATURAL, -7,
...
// unique major demons ('&')
{
    ...
    0, 15, MONS_PANDEMONIUM_DEMON, MONS_PANDEMONIUM_DEMON, MH_DEMONIC, MAG_IMMUNE,
...

{
    ...
    0, 15, MONS_PANDEMONIUM_DEMON, MONS_PANDEMONIUM_DEMON, MH_DEMONIC, -6,
    { {AT_HIT, AF_PLAIN, 60}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 21, 0, 0, 650 },
...

{
    ...
    0, 15, MONS_PANDEMONIUM_DEMON, MONS_PANDEMONIUM_DEMON, MH_DEMONIC, -14,
    { {AT_HIT, AF_PLAIN, 45}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 16, 0, 0, 350 },
