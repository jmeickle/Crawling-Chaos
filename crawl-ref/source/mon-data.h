...
// spiders and insects ('s')
{
    ...
    M_NO_SKELETON,
    MR_VUL_POISON,
    250, 10, MONS_INSECT, MONS_GIANT_COCKROACH, MH_NATURAL, -1,
...

{
    ...
    M_NO_SKELETON,
    MR_VUL_POISON,
    300, 10, MONS_ARACHNID, MONS_GIANT_MITE, MH_NATURAL, -1,
...

{
    ...
    M_NO_SKELETON,
    MR_VUL_POISON,
    250, 10, MONS_INSECT, MONS_GIANT_CENTIPEDE, MH_NATURAL, -3,
...

{
    ...
    M_NO_SKELETON,
    MR_VUL_POISON,
    320, 13, MONS_ARACHNID, MONS_SCORPION, MH_NATURAL, -3,
...

{
    ...
    M_NO_SKELETON,
    MR_RES_POISON,
    900, 9, MONS_ARACHNID, MONS_SCORPION, MH_NATURAL, -3,
...

{
    ...
    MR_VUL_POISON,
    250, 10, MONS_ARACHNID, MONS_SPIDER, MH_NATURAL, -3,
...

{
    ...
    M_NO_SKELETON | M_WEB_SENSE,
    MR_VUL_POISON,
    300, 6, MONS_ARACHNID, MONS_SPIDER, MH_NATURAL, -3,
...

{
    ...
    M_NO_SKELETON | M_WEB_SENSE,
    MR_VUL_POISON,
    900, 3, MONS_ARACHNID, MONS_SPIDER, MH_NATURAL, -3,
...

{
    ...
    MR_VUL_POISON,
    240, 4, MONS_ARACHNID, MONS_SPIDER, MH_NATURAL, -3,
...

{
    ...
    M_NO_SKELETON | M_WEB_SENSE,
    MR_VUL_POISON,
    130, 4, MONS_ARACHNID, MONS_SPIDER, MH_NATURAL, -3,
...

{
    ...
    MR_VUL_POISON,
    300, 13, MONS_ARACHNID, MONS_SPIDER, MH_NATURAL, -6,
...

{
    ...
    M_WARM_BLOOD | M_GLOWS_RADIATION | M_HERD,
    MR_NO_FLAGS,
    830, 10, MONS_UGLY_THING, MONS_UGLY_THING, MH_NATURAL, -3,
    { {AT_HIT, AF_PLAIN, 17}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 12, 3, 5, 0 },
...

{
    ...
    MR_NO_FLAGS,
    280, 10, MONS_WORM, MONS_WORM, MH_NATURAL, -3,
    { {AT_BITE, AF_PLAIN, 6}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 5, 3, 3, 0 },
...

{
    ...
    MR_NO_FLAGS,
    450, 10, MONS_WORM, MONS_WORM, MH_NATURAL, -3,
...

{
    ...
    1650, 13, MONS_WORM, MONS_WORM, MH_NATURAL, -3,
...

{
    ...
    MR_NO_FLAGS,
    1000, 10, MONS_WORM, MONS_WORM, MH_NATURAL, -3,
...
// small abominations ('x')
{
    ...
    MR_NO_FLAGS,
    0, 12, MONS_HORROR, MONS_HORROR, MH_NATURAL, -3,
    { {AT_HIT, AF_PLAIN, 12}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 7, 3, 5, 0 },
...
// flying insects ('y')
{
    ...
    M_NO_SKELETON,
    MR_VUL_POISON,
    170, 15, MONS_INSECT, MONS_YELLOW_WASP, MH_NATURAL, -3,
...

{
    ...
    M_NO_SKELETON | M_BLOOD_SCENT,
    MR_NO_FLAGS,
    200, 10, MONS_INSECT, MONS_VAMPIRE_MOSQUITO, MH_UNDEAD, -3,
...

{
    ...
    M_NO_SKELETON,
    MR_VUL_POISON,
    180, 12, MONS_INSECT, MONS_RED_WASP, MH_NATURAL, -3,
...
{   // dummy for moth genus
    ...
    MR_NO_FLAGS,
    300, 10, MONS_INSECT, MONS_MOTH, MH_NATURAL, -3,
...

{
    ...
    MR_RES_COLD,
    0, 10, MONS_SKELETON, MONS_LICH, MH_UNDEAD, -7,
    { {AT_HIT, AF_PLAIN, 25}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 10, 5, 3, 0 },
...

{
    ...
    0, 17, MONS_ZOMBIE, MONS_ZOMBIE, MH_UNDEAD, -4,
...
// placed in the Crypt.
{
    ...
    0, 20, MONS_SKELETON, MONS_LICH, MH_UNDEAD, MAG_IMMUNE,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 13, 0, 0, 66 },
...
// Curse toes move at half the speed with which they attack.
{
    ...
    0, 60, MONS_SKELETON, MONS_LICH, MH_UNDEAD, MAG_IMMUNE,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 14, 0, 0, 77 },
...
// beetles ('B')
{
    ...
    M_NO_SKELETON,
    MR_VUL_POISON,
    800, 12, MONS_INSECT, MONS_BEETLE, MH_NATURAL, -3,
...

{
    ...
    M_NO_SKELETON,
    MR_VUL_POISON,
    2050, 8, MONS_INSECT, MONS_BEETLE, MH_NATURAL, -3,
...

{
    ...
    MR_VUL_POISON,
    1300, 10, MONS_INSECT, MONS_BEETLE, MH_NATURAL, -3,
...

{
    ...
    MR_RES_POISON | MR_RES_HELLFIRE,
    0, 18, MONS_DRAGON, MONS_SERPENT_OF_HELL, MH_DEMONIC, -13,
...
// "H"ybrids.
{
    ...
    900, 10, MONS_ARACHNID, MONS_ARACHNE, MH_NATURAL, -3,
    { {AT_HIT, AF_PLAIN, 30}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 17, 0, 0, 200 },
