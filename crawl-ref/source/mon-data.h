...
// ants ('a')
{
    ...
    M_NO_SKELETON,
    MR_VUL_POISON,
    450, 10, MONS_ANT, MONS_ANT, MH_NATURAL, -3,
...

{
    ...
    M_NO_SKELETON,
    MR_VUL_POISON,
    450, 10, MONS_ANT, MONS_WORKER_ANT, MH_NATURAL, -3,
    { {AT_BITE, AF_POISON, 8}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 3, 3, 5, 0 },
    4, 10, MST_NO_SPELLS, CE_CLEAN, Z_SMALL, S_SILENT,
    I_INSECT, HT_LAND, FL_NONE, 12, DEFAULT_ENERGY,
...

{
    ...
    MR_VUL_POISON,
    900, 10, MONS_ANT, MONS_QUEEN_ANT, MH_NATURAL, -3,
...

{
    ...
    M_NO_SKELETON,
    MR_VUL_POISON,
    600, 10, MONS_ANT, MONS_SOLDIER_ANT, MH_NATURAL, -3,
...

{
    ...
    M_NO_SKELETON,
    MR_VUL_POISON,
    150, 5, MONS_ANT, MONS_ANT_LARVA, MH_NATURAL, -3,
...
{
    MONS_BIRD, 'b', BLUE, "bird",
    M_SENSE_INVIS,
    MR_NO_FLAGS,
    250, 9, MONS_BIRD, MONS_BIRD, MH_NATURAL, -2,
...

{
    ...
    M_SENSE_INVIS,
    MR_NO_FLAGS,
    250, 9, MONS_BIRD, MONS_RAVEN, MH_NATURAL, -2,
    { {AT_PECK, AF_PLAIN, 8}, {AT_CLAW, AF_PLAIN, 8}, AT_NO_ATK, AT_NO_ATK },
    { 6, 4, 3, 0 },
    1, 10, MST_NO_SPELLS, CE_CONTAMINATED, Z_SMALL, S_CAW,
    I_ANIMAL, HT_LAND, FL_FLY, 20, DEFAULT_ENERGY,
...

{
    ...
    480, 12, MONS_BIRD, MONS_PHOENIX, MH_HOLY, -3,
...

{
    ...
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    1900, 10, MONS_YAK, MONS_YAKTAUR, MH_NATURAL, -3,
...
{
    MONS_DEEP_ELF, 'e', RED, "deep elf",
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    450, 10, MONS_ELF, MONS_DEEP_ELF, MH_NATURAL, -3,
    { {AT_HIT, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 7, 3, 3, 0 },
    2, 14, MST_NO_SPELLS, CE_CONTAMINATED, Z_SMALL, S_SHOUT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
...
{
    MONS_HIGH_ELF, 'e', RED, "high elf",
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    450, 10, MONS_ELF, MONS_HIGH_ELF, MH_NATURAL, -3,
    { {AT_HIT, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 7, 3, 3, 0 },
    2, 14, MST_NO_SPELLS, CE_CONTAMINATED, Z_SMALL, S_SHOUT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
...

{
    ...
    MR_NO_FLAGS,
    450, 10, MONS_ELF, MONS_DEEP_ELF, MH_NATURAL, -6,
...

{
    ...
    MR_NO_FLAGS,
    450, 10, MONS_ELF, MONS_DEEP_ELF, MH_NATURAL, -5,
...

{
    ...
    MR_NO_FLAGS,
    450, 12, MONS_ELF, MONS_DEEP_ELF, MH_NATURAL, -6,
...

{
    ...
    MR_NO_FLAGS,
    0, 14, MONS_GOBLIN, MONS_BOGGART, MH_NATURAL, -7,
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 2, 3, 5, 0 },
...
// hounds and hogs ('h')
{
    ...
    MR_NO_FLAGS,
    360, 10, MONS_WOLF, MONS_JACKAL, MH_NATURAL, -1,
...

{
    ...
    MR_NO_FLAGS,
    300, 10, MONS_WOLF, MONS_HOUND, MH_NATURAL, -3,
...

{
    ...
    M_SENSE_INVIS | M_WARM_BLOOD | M_BLOOD_SCENT,
    MR_RES_POISON,
    750, 12, MONS_WOLF, MONS_WARG, MH_NATURAL, -6,
...

{
    ...
    M_SENSE_INVIS | M_WARM_BLOOD | M_BLOOD_SCENT,
    MR_NO_FLAGS,
    450, 10, MONS_WOLF, MONS_WOLF, MH_NATURAL, -3,
...

{
    ...
    M_SENSE_INVIS | M_WARM_BLOOD | M_BLOOD_SCENT,
    MR_NO_FLAGS,
    450, 19, MONS_WOLF, MONS_WAR_DOG, MH_NATURAL, -3,
...

{
    ...
    450, 10, MONS_WOLF, MONS_HELL_HOUND, MH_DEMONIC, -3,
...
// lizards ('l')
{
    MONS_LIZARD, 'l', GREEN, "lizard",
    M_COLD_BLOOD,
    MR_NO_FLAGS,
    170, 10, MONS_LIZARD, MONS_LIZARD, MH_NATURAL, -3,
    { {AT_BITE, AF_PLAIN, 3}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 1, 1, 2, 0 },
...

{
    ...
    M_COLD_BLOOD,
    MR_NO_FLAGS,
    170, 10, MONS_LIZARD, MONS_GIANT_NEWT, MH_NATURAL, -3,
    { {AT_BITE, AF_PLAIN, 3}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 1, 1, 2, 0 },
    0, 15, MST_NO_SPELLS, CE_CLEAN, Z_SMALL, S_SILENT,
    I_REPTILE, HT_AMPHIBIOUS, FL_NONE, 10, SWIM_ENERGY(6),
...

{
    ...
    M_COLD_BLOOD,
    MR_NO_FLAGS,
    250, 16, MONS_LIZARD, MONS_GIANT_GECKO, MH_NATURAL, -3,
    { {AT_BITE, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 1, 3, 5, 0 },
    1, 14, MST_NO_SPELLS, CE_CLEAN, Z_SMALL, S_SILENT,
...

{
    ...
    M_COLD_BLOOD,
    MR_NO_FLAGS,
    400, 13, MONS_LIZARD, MONS_IGUANA, MH_NATURAL, -3,
...

{
    ...
    MR_NO_FLAGS,
    450, 15, MONS_LIZARD, MONS_BASILISK, MH_NATURAL, -3,
    { {AT_BITE, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 6, 4, 4, 0 },
...

{
    ...
    M_COLD_BLOOD,
    MR_NO_FLAGS,
    800, 10, MONS_LIZARD, MONS_KOMODO_DRAGON, MH_NATURAL, -3,
...

{
    ...
    MR_NO_FLAGS,
    500, 10, MONS_MERFOLK, MONS_MERMAID, MH_NATURAL, -5,
    { {AT_HIT, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 8, 3, 3, 0 },
    4, 12, MST_NO_SPELLS, CE_CONTAMINATED, Z_SMALL, S_SHOUT,
    I_NORMAL, HT_AMPHIBIOUS, FL_NONE, 10, SWIM_ENERGY(6),
...

{
    ...
    M_SPELLCASTER | M_WARM_BLOOD | M_SPEAKS | M_FAKE_SPELLS,
    MR_NO_FLAGS,
    500, 10, MONS_MERFOLK, MONS_SIREN, MH_NATURAL, -7,
    { {AT_HIT, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 13, 5, 3, 0 },
    4, 12, MST_NO_SPELLS, CE_CONTAMINATED, Z_SMALL, S_SHOUT,
    I_NORMAL, HT_AMPHIBIOUS, FL_NONE, 10, SWIM_ENERGY(6),
...
// flags are set based on the current player's species!
{
    ...
    M_FIGHTER | M_SPEAKS | M_SPELLCASTER | M_ACTUAL_SPELLS | M_INSUBSTANTIAL
        | M_NO_POLY_TO,
    MR_RES_POISON,
    0, 15, MONS_ILLUSION, MONS_PLAYER_ILLUSION, MH_NATURAL, -5,
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 4, 2, 3, 0 },
    1, 2, MST_GHOST, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT,
    I_HIGH, HT_LAND, FL_LEVITATE, 10, DEFAULT_ENERGY,
...
{
    MONS_ILLUSION, '@', WHITE, "illusion",
    M_FIGHTER | M_SPEAKS | M_SPELLCASTER | M_ACTUAL_SPELLS | M_INSUBSTANTIAL
        | M_NO_POLY_TO,
    MR_RES_POISON,
    0, 15, MONS_ILLUSION, MONS_ILLUSION, MH_NATURAL, -5,
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 4, 2, 3, 0 },
    1, 2, MST_GHOST, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT,
    I_HIGH, HT_LAND, FL_LEVITATE, 10, DEFAULT_ENERGY,
...

{
    ...
    mrd(MR_RES_COLD, 3),
    0, 16, MONS_GHOST, MONS_SHADOW, MH_UNDEAD, -5,
...

{
    ...
    mrd(MR_RES_COLD, 3),
    0, 10, MONS_GHOST, MONS_SILENT_SPECTRE, MH_UNDEAD, -4,
    { {AT_HIT, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 8, 3, 5, 0 },
...
// never spawned as a monster.
{
    ...
    MR_NO_FLAGS,
    0, 15, MONS_PLAYER, MONS_PLAYER, MH_NATURAL, -5,
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 4, 2, 3, 0 },
...
{
    MONS_BUG, 's', BROWN, "bug",
    M_NO_SKELETON,
    MR_VUL_POISON,
    250, 10, MONS_BUG, MONS_BUG, MH_NATURAL, -1,
...

{
    ...
    M_NO_SKELETON,
    MR_VUL_POISON,
    250, 10, MONS_BUG, MONS_GIANT_COCKROACH, MH_NATURAL, -1,
    { {AT_BITE, AF_PLAIN, 2}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 1, 3, 4, 0 },
    3, 10, MST_NO_SPELLS, CE_CONTAMINATED, Z_SMALL, S_SILENT,
    I_INSECT, HT_LAND, FL_NONE, 12, DEFAULT_ENERGY,
...

{
    ...
    M_NO_SKELETON,
    MR_VUL_POISON,
    300, 10, MONS_BUG, MONS_GIANT_MITE, MH_NATURAL, -1,
...

{
    ...
    M_NO_SKELETON,
    MR_VUL_POISON,
    250, 10, MONS_BUG, MONS_GIANT_CENTIPEDE, MH_NATURAL, -3,
...

{
    ...
    M_NO_SKELETON,
    MR_RES_POISON,
    900, 9, MONS_SCORPION, MONS_SCORPION, MH_NATURAL, -3,
...

{
    ...
    900, 4, MONS_DEMON, MONS_DEMONIC_CRAWLER, MH_DEMONIC, -6,
...
// ugly things ('u')
{
    ...
    { {AT_HIT, AF_PLAIN, 12}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 8, 3, 5, 0 },
    3, 10, MST_NO_SPELLS, CE_MUTAGEN, Z_NOZOMBIE, S_GURGLE,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 17}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 12, 3, 5, 0 },
    4, 10, MST_NO_SPELLS, CE_MUTAGEN, Z_NOZOMBIE, S_GURGLE,
    I_ANIMAL, HT_LAND, FL_NONE, 11, ACTION_ENERGY(11),
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_LARGE
},
...
},
{
    ...
    M_CONFUSED | M_INSUBSTANTIAL | M_GLOWS_LIGHT,
    MR_RES_POISON | mrd(MR_RES_FIRE, 3) | MR_VUL_COLD | MR_RES_ELEC,
    0, 5, MONS_CLOUD, MONS_FIRE_VORTEX, MH_NONLIVING, MAG_IMMUNE,
    { {AT_HIT, AF_FIRE, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 8, 2, 3, 0 },
    0, 5, MST_NO_SPELLS, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_PLANT, HT_LAND, FL_LEVITATE, 15, DEFAULT_ENERGY,
...

{
    ...
    0, 5, MONS_CLOUD, MONS_SPATIAL_VORTEX, MH_NONLIVING, MAG_IMMUNE,
...

{
    ...
    0, 10, MONS_CLOUD, MONS_VAPOUR, MH_NONLIVING, MAG_IMMUNE,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 12, 2, 3, 0 },
...

{
    ...
    0, 15, MONS_CLOUD, MONS_INSUBSTANTIAL_WISP,
...
{ // miscast only
    ...
    0, 5, MONS_CLOUD, MONS_TWISTER, MH_NONLIVING, MAG_IMMUNE,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 12, 0, 0, 10000 },
    0, 5, MST_NO_SPELLS, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_PLANT, HT_LAND, FL_LEVITATE, 10, DEFAULT_ENERGY,
...
// small abominations ('x')
{
    ...
    MR_NO_FLAGS,
    0, 12, MONS_HORROR, MONS_UNSEEN_HORROR, MH_NATURAL, -3,
    { {AT_HIT, AF_PLAIN, 12}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 7, 3, 5, 0 },
...

{
    ...
    // as just MH_UNDEAD.
    MONS_ABOMINATION, 'x', BLACK, "abomination",
    M_NO_FLAGS,
    MR_NO_FLAGS,
    0, 10, MONS_HORROR, MONS_ABOMINATION, MH_UNDEAD, -5,
    { {AT_HIT, AF_PLAIN, 23}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 6, 2, 5, 0 },
    0, 0, MST_NO_SPELLS, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_PLANT, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
...

{
    ...
    mrd(MR_RES_COLD, 2),
    0, 8, MONS_HORROR, MONS_ABOMINATION, MH_UNDEAD, MAG_IMMUNE,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 1, 1, 0, 0 },
    1, 0, MST_NO_SPELLS, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
...
// flying insects ('y')
{
    MONS_FLYING_BUG, 'y', YELLOW, "flying bug",
    M_NO_SKELETON,
    MR_VUL_POISON,
    170, 15, MONS_FLYING_BUG, MONS_FLYING_BUG, MH_NATURAL, -3,
...

{
    ...
    M_NO_SKELETON,
    MR_VUL_POISON,
    170, 15, MONS_FLYING_BUG, MONS_YELLOW_WASP, MH_NATURAL, -3,
    { {AT_STING, AF_PARALYSE, 13}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 4, 3, 5, 0 },
    5, 14, MST_NO_SPELLS, CE_POISONOUS, Z_SMALL, S_SILENT,
    I_PLANT, HT_LAND, FL_FLY, 15, DEFAULT_ENERGY,
...

{
    ...
    M_NO_SKELETON | M_BLOOD_SCENT,
    MR_RES_COLD,
    200, 10, MONS_FLYING_BUG, MONS_VAMPIRE_MOSQUITO, MH_UNDEAD, -3,
...

{
    ...
    M_NO_SKELETON,
    MR_VUL_POISON,
    180, 12, MONS_FLYING_BUG, MONS_RED_WASP, MH_NATURAL, -3,
...

{
    ...
    600, 18, MONS_HORROR, MONS_GHOST_MOTH, MH_NATURAL, -6,
    { {AT_HIT, AF_DRAIN_STAT, 18}, {AT_HIT, AF_DRAIN_STAT, 18},
      {AT_STING, AF_POISON_NASTY, 12}, AT_NO_ATK },
    { 13, 3, 5, 0 },
    16, 10, MST_NO_SPELLS, CE_MUTAGEN, Z_NOZOMBIE, S_SILENT,
    I_INSECT, HT_LAND, FL_FLY, 12, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_LARGE
},
...

{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 9, 3, 5, 0 },
    0, 14, MST_NO_SPELLS, CE_CONTAMINATED, Z_NOZOMBIE, S_SILENT,
    I_INSECT, HT_LAND, FL_FLY, 15, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_SMALL
},
...

{
    ...
    M_NO_FLAGS,
    MR_RES_COLD,
    0, 16, MONS_ZOMBIE, MONS_WIGHT, MH_UNDEAD, -4,
...

{
    ...
    mrd(MR_RES_COLD, 2) | MR_RES_ELEC,
    0, 10, MONS_SKELETON, MONS_SKELETAL_WARRIOR, MH_UNDEAD, -7,
    { {AT_HIT, AF_PLAIN, 25}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 10, 5, 3, 0 },
...

{
    ...
    M_NO_FLAGS,
    mrd(MR_RES_COLD, 2) | MR_RES_ELEC,
    0, 10, MONS_SKELETON, MONS_FLYING_SKULL, MH_UNDEAD, -3,
    { {AT_HIT, AF_PLAIN, 7}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 2, 3, 5, 0 },
...

{
    ...
    MR_RES_ELEC | MR_RES_HELLFIRE | MR_RES_STICKY_FLAME,
    0, 17, MONS_ZOMBIE, MONS_FLAMING_CORPSE, MH_UNDEAD, -4,
...
// placed in the Crypt.
{
    ...
    mrd(MR_RES_COLD, 2) | MR_RES_HELLFIRE | MR_RES_ELEC,
    0, 20, MONS_SKELETON, MONS_CURSE_SKULL, MH_UNDEAD, MAG_IMMUNE,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 13, 0, 0, 66 },
...
// Curse toes move at half the speed with which they attack.
{
    ...
    mrd(MR_RES_COLD, 2) | MR_RES_HELLFIRE | MR_RES_ELEC,
    0, 60, MONS_SKELETON, MONS_CURSE_SKULL, MH_UNDEAD, MAG_IMMUNE,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 14, 0, 0, 77 },
...
// beetles ('B')
{
    ...
    M_NO_SKELETON,
    MR_VUL_POISON,
    800, 12, MONS_BUG, MONS_GOLIATH_BEETLE, MH_NATURAL, -3,
...

{
    ...
    M_NO_SKELETON,
    MR_VUL_POISON,
    2050, 8, MONS_BUG, MONS_BOULDER_BEETLE, MH_NATURAL, -3,
...

{
    ...
    MR_VUL_POISON,
    1300, 10, MONS_BUG, MONS_BORING_BEETLE, MH_NATURAL, -3,
...

{
    ...
    M_WARM_BLOOD,
    MR_NO_FLAGS,
    1200, 15, MONS_DRAGON, MONS_WYVERN, MH_NATURAL, -3,
    { {AT_BITE, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 5, 3, 5, 0 },
...

{
    ...
    M_SENSE_INVIS,
    mrd(MR_RES_COLD, 2) | MR_RES_ELEC,
    0, 12, MONS_SKELETON, MONS_BONE_DRAGON, MH_UNDEAD, -4,
...
// elementals (E)
{
    MONS_ELEMENTAL, 'E', ETC_EARTH, "elemental",
    M_NO_FLAGS,
...

{
    ...
    0, 10, MONS_ELEMENTAL, MONS_WATER_ELEMENTAL, MH_NONLIVING, MAG_IMMUNE,
    { {AT_HIT, AF_PLAIN, 25}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 6, 5, 3, 0 },
...
// frogs ('F')
{
    MONS_FROG, 'F', GREEN, "frog",
    M_COLD_BLOOD,
    MR_NO_FLAGS,
    600, 10, MONS_FROG, MONS_FROG, MH_NATURAL, -3,
    { {AT_HIT, AF_PLAIN, 9}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 4, 3, 5, 0 },
    // XXX: Will be Z_SMALL, but is Z_BIG until code for zombie spawns
    // is no longer based on zombie size
...

{
    ...
    M_COLD_BLOOD,
    MR_NO_FLAGS,
    600, 10, MONS_FROG, MONS_GIANT_FROG, MH_NATURAL, -3,
    { {AT_HIT, AF_PLAIN, 9}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 4, 3, 5, 0 },
    // XXX: Will be Z_SMALL, but is Z_BIG until code for zombie spawns
    // is no longer based on zombie size
...

{
    ...
    M_COLD_BLOOD,
    MR_RES_POISON,
    700, 16, MONS_FROG, MONS_SPINY_FROG, MH_NATURAL, -3,
...

{
    ...
    MR_NO_FLAGS,
    450, 13, MONS_FROG, MONS_BLINK_FROG, MH_NATURAL, -5,
...
// hybrids ('H')
{
    ...
    M_WARM_BLOOD,
    MR_NO_FLAGS,
    1150, 8, MONS_BIRD, MONS_HIPPOGRIFF, MH_NATURAL, -3,
...

{
    ...
    M_WARM_BLOOD,
    MR_NO_FLAGS,
    1700, 5, MONS_BIRD, MONS_GRIFFON, MH_NATURAL, -3,
...

{
    ...
    MR_RES_POISON,
    480, 9, MONS_BIRD, MONS_HARPY, MH_NATURAL, -3,
...

{
    ...
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    550, 10, MONS_BIRD, MONS_TENGU, MH_NATURAL, -3,
...
// various beasts ('I')
{
    ...
    0, 13, MONS_ELEMENTAL, MONS_ICE_BEAST, MH_NATURAL, -3,
...

{
    ...
    480, 13, MONS_ELEMENTAL, MONS_SKY_BEAST, MH_NATURAL, -3,
    { {AT_HIT, AF_ELEC, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 5, 3, 5, 0 },
    3, 13, MST_NO_SPELLS, CE_MUTAGEN, Z_NOZOMBIE, S_SILENT,
    I_ANIMAL, HT_LAND, FL_FLY, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_LARGE
},
...
// liches ('L')
{
    ...
    mrd(MR_RES_COLD, 2) | MR_RES_ELEC,
    0, 18, MONS_SKELETON, MONS_LICH, MH_UNDEAD, -11,
...

{
    ...
    M_SPELLCASTER | M_ACTUAL_SPELLS | M_SEE_INVIS | M_SPEAKS,
    mrd(MR_RES_COLD, 2) | MR_RES_ELEC,
    0, 24, MONS_SKELETON, MONS_LICH, MH_UNDEAD, -14,
...
// mummies ('M')
{
    ...
    M_NO_FLAGS,
    MR_VUL_FIRE | MR_RES_COLD | MR_RES_ELEC,
...

{
    ...
    I_NORMAL, HT_AMPHIBIOUS, FL_NONE, 10, SWIM_ENERGY(14), // TODO: fix
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_MEDIUM
},
...

{
    ...
    MR_VULN_FIRE | MR_RES_COLD | MR_RES_ELEC,
...

{
    ...
    I_HIGH, HT_LAND, FL_NONE, 10, MOVE_ENERGY(12),
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},
...
// nagas ('N')
{
    ...
    MR_RES_POISON,
    1000, 10, MONS_SERPENT, MONS_NAGA, MH_NATURAL, -6,
...

{
    ...
    MR_RES_POISON,
    1000, 13, MONS_SERPENT, MONS_NAGA, MH_NATURAL, -6,
    { {AT_HIT, AF_PLAIN, 17}, {AT_CONSTRICT, AF_CRUSH, 30},
       AT_NO_ATK, AT_NO_ATK },
    { 7, 3, 5, 0 },
...

{
    ...
    MR_RES_POISON,
    1000, 8, MONS_SERPENT, MONS_NAGA, MH_NATURAL, -6,
...

{
    ...
    M_FIGHTER | M_SPELLCASTER | M_ACTUAL_SPELLS | M_SEE_INVIS | M_WARM_BLOOD
        | M_SPEAKS,
    MR_RES_POISON,
    1000, 11, MONS_SERPENT, MONS_NAGA, MH_NATURAL, MAG_IMMUNE,
...
// fake R - conjured by the R's illusion spell.
{
    ...
    M_NO_FLAGS,
    MR_RES_POISON,
    0, 10, MONS_ILLUSION, MONS_RAKSHASA_FAKE, MH_DEMONIC, MAG_IMMUNE,
...
// snakes ('S')
{
    MONS_SERPENT, 'S', LIGHTGREEN, "serpent",
    M_COLD_BLOOD,
    MR_NO_FLAGS,
    200, 10, MONS_SERPENT, MONS_SERPENT, MH_NATURAL, -3,
    { {AT_BITE, AF_POISON, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 2, 3, 5, 0 },
...

{
    ...
    M_COLD_BLOOD,
    MR_NO_FLAGS,
    100, 13, MONS_SERPENT, MONS_BALL_PYTHON, MH_NATURAL, -1,
...

{
    ...
    M_COLD_BLOOD,
    MR_NO_FLAGS,
    200, 10, MONS_SERPENT, MONS_ADDER, MH_NATURAL, -3,
    { {AT_BITE, AF_POISON, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 2, 3, 5, 0 },
    1, 15, MST_NO_SPELLS, CE_CLEAN, Z_SMALL, S_SILENT,
    I_REPTILE, HT_AMPHIBIOUS, FL_NONE, 13, SWIM_ENERGY(6),
...

{
    ...
    M_COLD_BLOOD,
    MR_RES_POISON,
    300, 11, MONS_SERPENT, MONS_WATER_MOCCASIN, MH_NATURAL, -3,
    { {AT_BITE, AF_POISON_MEDIUM, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 4, 3, 5, 0 },
...

{
    ...
    M_COLD_BLOOD,
    MR_RES_POISON,
    500, 12, MONS_SERPENT, MONS_BLACK_MAMBA, MH_NATURAL, -3,
    { {AT_BITE, AF_POISON_MEDIUM, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 7, 3, 5, 0 },
...

{
    ...
    M_COLD_BLOOD | M_SUBMERGES,
    MR_NO_FLAGS,
    400, 10, MONS_SERPENT, MONS_SEA_SNAKE, MH_NATURAL, -3,
...

{
    ...
    M_COLD_BLOOD,
    MR_NO_FLAGS,
    750, 10, MONS_SERPENT, MONS_ANACONDA, MH_NATURAL, -3,
...

{
    ...
    MR_RES_POISON,
    800, 10, MONS_SERPENT, MONS_GUARDIAN_SERPENT, MH_NATURAL, -6,
    { {AT_HIT, AF_PLAIN, 26}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 8, 3, 5, 0 },
...
// large abominations ('X')
{
    ...
    // See comment under MONS_ABOMINATION_SMALL regarding holiness.
    MONS_HORROR, 'X', BLACK, "horror",
    M_NO_FLAGS,
    MR_NO_FLAGS,
    0, 10, MONS_HORROR, MONS_HORROR, MH_UNDEAD, -7,
    { {AT_HIT, AF_PLAIN, 40}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 11, 2, 5, 0 },
    0, 0, MST_NO_SPELLS, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_PLANT, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
...

{
    ...
    M_NO_FLAGS,
    MR_NO_FLAGS,
    0, 10, MONS_ABOMINATION, MONS_ABOMINATION, MH_UNDEAD, -7,
    { {AT_HIT, AF_PLAIN, 40}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 11, 2, 5, 0 },
    0, 0, MST_NO_SPELLS, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_PLANT, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
...

{
    ...
    M_SEE_INVIS,
    MR_RES_POISON | MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC,
    0, 10, MONS_HORROR, MONS_TENTACLED_MONSTROSITY,
        MH_DEMONIC, -5,
...
{
    MONS_GIANT_ORANGE_BRAIN, 'X', LIGHTRED, "giant orange brain",
    M_WARM_BLOOD | M_NO_SKELETON | M_SPELLCASTER | M_SEE_INVIS,
    MR_RES_ASPHYX,
    500, 13, MONS_HORROR, MONS_GIANT_ORANGE_BRAIN, MH_NATURAL, -8,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 10, 3, 5, 0 },
...
{
    MONS_GREAT_ORB_OF_EYES, 'X', LIGHTGREEN, "great orb of eyes",
    M_NO_SKELETON | M_SPELLCASTER | M_SEE_INVIS,
    MR_RES_POISON,
    700, 13, MONS_HORROR, MONS_GREAT_ORB_OF_EYES, MH_NATURAL, MAG_IMMUNE,
    { {AT_BITE, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 12, 3, 5, 0 },
...
// water monsters
{
    MONS_FISH, ';', LIGHTGREEN, "fish",
    M_COLD_BLOOD | M_SUBMERGES,
    MR_NO_FLAGS,
    300, 7, MONS_FISH, MONS_FISH, MH_NATURAL, -3,
    { {AT_BITE, AF_PLAIN, 8}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 4, 3, 5, 0 },
...

{
    ...
    M_COLD_BLOOD | M_SUBMERGES,
    MR_NO_FLAGS,
    300, 7, MONS_FISH, MONS_BIG_FISH, MH_NATURAL, -3,
    { {AT_BITE, AF_PLAIN, 8}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 4, 3, 5, 0 },
    1, 12, MST_NO_SPELLS, CE_CLEAN, Z_SMALL, S_SILENT,
    I_REPTILE, HT_WATER, FL_NONE, 10, DEFAULT_ENERGY,
...

{
    ...
    M_COLD_BLOOD | M_SUBMERGES,
    MR_NO_FLAGS,
    450, 5, MONS_FISH, MONS_GIANT_GOLDFISH, MH_NATURAL, -3,
    { {AT_BITE, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 7, 3, 5, 0 },
...

{
    ...
    M_COLD_BLOOD | M_SUBMERGES,
    mrd(MR_RES_ELEC, 2),
    300, 19, MONS_FISH, MONS_ELECTRIC_EEL, MH_NATURAL, -3,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 3, 3, 5, 0 },
    1, 15, MST_NO_SPELLS, CE_CLEAN, Z_SMALL, S_SILENT,
    I_REPTILE, HT_WATER, FL_NONE, 10, DEFAULT_ENERGY,
...
// of bone or similar materials (e.g. chitin)
{
    ...
    MR_NO_FLAGS,
    2000, 9, MONS_FISH, MONS_SHARK, MH_NATURAL, -3,
...

{
    ...
    MR_NO_FLAGS,
    0, 10, MONS_KRAKEN, MONS_KRAKEN, MH_NATURAL, MAG_IMMUNE,
...
// lava monsters
{
    ...
    0, 6, MONS_WORM, MONS_LAVA_WORM, MH_NATURAL, -3,
...

{
    ...
    mrd(MR_RES_FIRE, 3) | MR_VUL_COLD,
    0, 10, MONS_FISH, MONS_LAVA_FISH, MH_NATURAL, -3,
...

{
    ...
    M_WARM_BLOOD | M_SUBMERGES,
    mrd(MR_RES_FIRE, 3) | MR_VUL_COLD,
    0, 17, MONS_SERPENT, MONS_LAVA_SNAKE, MH_NATURAL, -3,
...
{   // mv: was another lava thing
    ...
    mrd(MR_RES_FIRE, 3) | MR_VUL_COLD,
    0, 10, MONS_ELEMENTAL, MONS_SALAMANDER, MH_NATURAL, -3,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 7, 3, 5, 0 },
    0, 10, MST_NO_SPELLS, CE_MUTAGEN, Z_NOZOMBIE, S_SILENT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_MEDIUM
},
...
// mimics
{
    MONS_MIMIC, 'X', BLACK, "mimic",
    M_NO_FLAGS,
    MR_NO_FLAGS,
    0, 10, MONS_MIMIC, MONS_MIMIC, MH_NONLIVING, -3,
    { {AT_HIT, AF_PLAIN, 4}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 8, 3, 5, 0 },
...

{
    ...
    M_NO_FLAGS,
    MR_NO_FLAGS,
    0, 10, MONS_MIMIC, MONS_ITEM_MIMIC, MH_NONLIVING, -3,
    { {AT_HIT, AF_PLAIN, 4}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 8, 3, 5, 0 },
    5, 1, MST_NO_SPELLS, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
...

{
    ...
    M_NO_FLAGS,
    MR_NO_FLAGS,
    0, 10, MONS_MIMIC, MONS_FEATURE_MIMIC, MH_NONLIVING, -3,
    { {AT_HIT, AF_PLAIN, 4}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 8, 3, 5, 0 },
    5, 1, MST_NO_SPELLS, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
...

{
    ...
    0, 13, MONS_MIMIC, MONS_ITEM_MIMIC, MH_NONLIVING, -3,
...

{
    ...
    M_NO_FLAGS,
    MR_RES_POISON | MR_RES_ELEC | MR_RES_FIRE | MR_RES_COLD,
    0, 13, MONS_MIMIC, MONS_FEATURE_MIMIC, MH_NONLIVING, -3,
    { {AT_HIT, AF_PLAIN, 4}, {AT_HIT, AF_POISON, 4}, {AT_CONSTRICT, AF_CRUSH, 4},
       AT_NO_ATK },
    { 8, 3, 5, 0 },
    5, 1, MST_NO_SPELLS, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
...
// Demonic tentacle things.
{
    ...
    0, 10, MONS_HORROR, MONS_ELDRITCH_TENTACLE,
        MH_NONLIVING, MAG_IMMUNE,
...

{
    ...
    M_SPEAKS,
    MR_RES_POISON | MR_RES_HELLFIRE | MR_VUL_COLD,
    0, 13, MONS_IMP, MONS_CRIMSON_IMP, MH_DEMONIC, -9,
    { {AT_HIT, AF_PLAIN, 4}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 3, 3, 3, 0 },
    3, 14, MST_NO_SPELLS, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT,
    I_HIGH, HT_LAND, FL_FLY, 10, DEFAULT_ENERGY,
...

{
    ...
    0, 14, MONS_IMP, MONS_IRON_IMP, MH_DEMONIC, -3,
    { {AT_HIT, AF_PLAIN, 12}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 3, 3, 5, 0 },
...
// devils etc. ('4')
{
    MONS_DEMON, '4', BLUE, "demon",
    M_NO_FLAGS,
    MR_RES_POISON | MR_VUL_FIRE | mrd(MR_RES_COLD, 3),
    0, 10, MONS_DEMON, MONS_DEMON, MH_DEMONIC, -5,
    { {AT_HIT, AF_PLAIN, 21}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 7, 3, 5, 0 },
...

{
    ...
    M_NO_FLAGS,
    MR_RES_POISON | MR_VUL_FIRE | mrd(MR_RES_COLD, 3),
    0, 10, MONS_DEMON, MONS_BLUE_DEVIL, MH_DEMONIC, -5,
    { {AT_HIT, AF_PLAIN, 21}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 7, 3, 5, 0 },
    14, 10, MST_NO_SPELLS, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_HIGH, HT_LAND, FL_FLY, 10, DEFAULT_ENERGY,
...

{
    ...
    M_NO_FLAGS,
    MR_RES_POISON | mrd(MR_RES_ELEC, 2) | MR_RES_HELLFIRE | MR_RES_COLD,
    0, 10, MONS_DEMON, MONS_IRON_DEVIL, MH_DEMONIC, -6,
...

{
    ...
    M_NO_FLAGS,
    MR_NO_FLAGS,
    0, 12, MONS_DEMON, MONS_ORANGE_DEMON, MH_DEMONIC, -6,
...

{
    ...
    M_FIGHTER,
    MR_RES_POISON | MR_RES_HELLFIRE | MR_VUL_COLD,
    0, 10, MONS_DEMON, MONS_RED_DEVIL, MH_DEMONIC, -7,
    { {AT_HIT, AF_PLAIN, 18}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 5, 3, 5, 0 },
    10, 10, MST_NO_SPELLS, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_NORMAL, HT_LAND, FL_FLY, 10, DEFAULT_ENERGY,
...

{
    ...
    M_NO_FLAGS,
    MR_RES_POISON | MR_RES_COLD,
    0, 10, MONS_DEMON, MONS_ROTTING_DEVIL, MH_DEMONIC, -7,
    { {AT_HIT, AF_ROT, 8}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 5, 3, 5, 0 },
...

{
    ...
    0, 6, MONS_DEMON, MONS_SIXFIRHY, MH_DEMONIC, -6,
...

{
    ...
    M_SPELLCASTER,
    MR_RES_POISON,
    0, 12, MONS_DEMON, MONS_HELLWING, MH_DEMONIC, -6,
...
// middle demons ('3')
{
    ...
    0, 14, MONS_DEMON, MONS_SUN_DEMON, MH_DEMONIC, -6,
...

{
    ...
    M_SEE_INVIS,
    MR_RES_POISON | MR_RES_COLD,
    0, 12, MONS_DEMON, MONS_SOUL_EATER, MH_DEMONIC, -10,
...

{
    ...
    M_NO_FLAGS,
    MR_RES_POISON | MR_VUL_FIRE | mrd(MR_RES_COLD, 3),
    0, 11, MONS_DEMON, MONS_ICE_DEVIL, MH_DEMONIC, -6,
...

{
    ...
    0, 12, MONS_DEMON, MONS_SMOKE_DEMON, MH_DEMONIC, -6,
...

{
    ...
    M_SPELLCASTER,
    MR_RES_POISON,
    0, 12, MONS_DEMON, MONS_NEQOXEC, MH_DEMONIC, -6,
    { {AT_HIT, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 6, 3, 5, 0 },
...

{
    ...
    0, 12, MONS_DEMON, MONS_YNOXINUL, MH_DEMONIC, -6,
    { {AT_HIT, AF_PLAIN, 12}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 6, 3, 5, 0 },
...

{
    ...
    M_SEE_INVIS,
    MR_NO_FLAGS,
    0, 12, MONS_DEMON, MONS_CHAOS_SPAWN, MH_DEMONIC, -7,
...

{
    ...
    M_SPELLCASTER | M_SEE_INVIS,
    MR_RES_POISON | mrd(MR_RES_COLD, 2),
    0, 12, MONS_GREATER_DEMON, MONS_SHADOW_DEMON, MH_DEMONIC, -7,
    { {AT_HIT, AF_PLAIN, 21}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 10, 3, 5, 0 },
...

{
    ...
    M_SPELLCASTER | M_SEE_INVIS,
    MR_RES_POISON,
    0, 13, MONS_GREATER_DEMON, MONS_GREEN_DEATH, MH_DEMONIC, -9,
    { {AT_HIT, AF_PLAIN, 32}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 13, 3, 5, 0 },
...

{
    ...
    0, 13, MONS_GREATER_DEMON, MONS_BLIZZARD_DEMON, MH_DEMONIC, -9,
...

{
    ...
    MR_RES_POISON | MR_RES_HELLFIRE | MR_VUL_COLD,
    0, 15, MONS_GREATER_DEMON, MONS_BALRUG, MH_DEMONIC, -9,
...

{
    ...
    0, 14, MONS_GREATER_DEMON, MONS_CACODEMON, MH_DEMONIC, -9,
...
{   // with randomised stats
    ...
    M_FIGHTER,
    MR_NO_FLAGS,
    0, 10, MONS_DEMON, MONS_HELL_BEAST, MH_DEMONIC, -3,
...

{
    ...
    MR_RES_POISON | MR_RES_HELLFIRE | MR_VUL_COLD,
    0, 12, MONS_GREATER_DEMON, MONS_HELLION, MH_DEMONIC, -7,
    { {AT_HIT, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 7, 3, 5, 0 },
...

{
    ...
    MR_RES_POISON | MR_RES_COLD,
    0, 10, MONS_GREATER_DEMON, MONS_REAPER, MH_DEMONIC, MAG_IMMUNE,
    { {AT_HIT, AF_PLAIN, 45}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 14, 3, 5, 0 },
...

{
    ...
    0, 12, MONS_GREATER_DEMON, MONS_LOROCYPROCA, MH_DEMONIC, -7,
...

{
    ...
    M_SPELLCASTER | M_SPEAKS,
    MR_RES_POISON | MR_RES_FIRE,
    0, 10, MONS_GREATER_DEMON, MONS_TORMENTOR, MH_DEMONIC, -6,
...

{
    ...
    M_SPELLCASTER | M_SEE_INVIS | M_GLOWS_LIGHT,
    MR_RES_POISON | MR_RES_HELLFIRE | MR_VUL_COLD,
    0, 15, MONS_FIEND, MONS_BRIMSTONE_FIEND, MH_DEMONIC, -12,
    { {AT_HIT, AF_PLAIN, 25}, {AT_HIT, AF_PLAIN, 15}, {AT_HIT, AF_PLAIN, 15},
       AT_NO_ATK },
    { 18, 3, 5, 0 },
    15, 6, MST_FIEND, CE_NOCORPSE, Z_NOZOMBIE, S_ROAR,
...

{
    ...
    0, 10, MONS_FIEND, MONS_HELL_SENTINEL, MH_DEMONIC, -12,
...
{
    MONS_GREATER_DEMON, '1', LIGHTGREY, "greater demon",
    M_FIGHTER | M_SPELLCASTER | M_SEE_INVIS,
    MR_RES_ELEC | MR_RES_FIRE | MR_RES_COLD | MR_RES_POISON,
    0, 14, MONS_GREATER_DEMON, MONS_GREATER_DEMON, MH_DEMONIC, -9,
...

{
    ...
    M_FIGHTER | M_SPELLCASTER | M_SEE_INVIS,
    MR_RES_ELEC | MR_RES_FIRE | MR_RES_COLD | MR_RES_POISON,
    0, 14, MONS_GREATER_DEMON, MONS_EXECUTIONER, MH_DEMONIC, -9,
    { {AT_HIT, AF_PLAIN, 30}, {AT_HIT, AF_PLAIN, 10}, {AT_HIT, AF_PLAIN, 10},
       AT_NO_ATK },
    { 12, 3, 5, 0 },
    10, 15, MST_EXECUTIONER, CE_NOCORPSE, Z_NOZOMBIE, S_SCREAM,
...
{
    MONS_ORB, '*', LIGHTCYAN, "orb",
    M_CONFUSED | M_INSUBSTANTIAL | M_GLOWS_LIGHT,
    mrd(MR_RES_ELEC | MR_RES_POISON | MR_RES_FIRE | MR_RES_COLD, 3),
    0, 20, MONS_ORB, MONS_ORB, MH_NONLIVING, MAG_IMMUNE,
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 12, 0, 0, 1 },
...

{
    ...
    M_CONFUSED | M_INSUBSTANTIAL | M_GLOWS_LIGHT,
    mrd(MR_RES_ELEC | MR_RES_POISON | MR_RES_FIRE | MR_RES_COLD, 3),
    0, 20, MONS_ORB, MONS_BALL_LIGHTNING, MH_NONLIVING, MAG_IMMUNE,
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 12, 0, 0, 1 },
    0, 10, MST_NO_SPELLS, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_PLANT, HT_LAND, FL_LEVITATE, 20, DEFAULT_ENERGY,
...

{
    ...
    M_NO_FLAGS,
    MR_RES_POISON,
    0, 10, MONS_FUNGUS, MONS_BALLISTOMYCETE, MH_PLANT, -3,
    { {AT_HIT, AF_PLAIN, 1}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 1, 0, 0, 1 },
    0, 10, MST_NO_SPELLS, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_PLANT, HT_LAND, FL_LEVITATE, 15, DEFAULT_ENERGY,
...

{
    ...
    0, 13, MONS_ORB, MONS_ORB_OF_FIRE, MH_NONLIVING, MAG_IMMUNE,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 30, 0, 0, 150 },
...
{ // not an actual monster, used by a spell
    ...
    mrd(MR_RES_POISON | MR_RES_COLD | MR_RES_ELEC, 3) | MR_RES_HELLFIRE
        | MR_RES_ACID | MR_RES_STICKY_FLAME,
    0, 0, MONS_ORB, MONS_ORB_OF_DESTRUCTION,
        MH_NONLIVING, MAG_IMMUNE,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
...

{
    ...
    mrd(MR_RES_COLD, 2) | MR_RES_POISON | MR_RES_ELEC,
    0, 65, MONS_SKELETON, MONS_BLESSED_TOE, MH_HOLY, MAG_IMMUNE,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 14, 0, 0, 77 },
...

{
    ...
    0, 13, MONS_ORB, MONS_SILVER_STAR, MH_HOLY, MAG_IMMUNE,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 30, 0, 0, 150 },
...
// other symbols
{
    ...
    M_SPEAKS,
    MR_RES_COLD,
    0, 10, MONS_PLANT, MONS_DEATH_COB, MH_UNDEAD, -3,
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 10, 4, 5, 0 },
...
// "F"rogs.
{
    ...
    M_UNIQUE | M_COLD_BLOOD | M_SPELLCASTER | M_ACTUAL_SPELLS | M_SPEAKS
        | M_PHASE_SHIFT,
    MR_NO_FLAGS,
    450, 12, MONS_FROG, MONS_BLINK_FROG, MH_NATURAL, -5,
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 6, 0, 0, 40 },
...

{
    ...
    M_UNIQUE | M_SENSE_INVIS | M_ACID_SPLASH | M_BURROWS | M_PRIEST | M_SPEAKS
        | M_SPELLCASTER,
    MR_RES_POISON | MR_RES_ASPHYX | MR_RES_ACID,
    0, 60, MONS_JELLY, MONS_DISSOLUTION, MH_NATURAL, -7,
    { {AT_HIT, AF_ACID, 50}, {AT_HIT, AF_ACID, 30}, AT_NO_ATK, AT_NO_ATK },
    { 12, 0, 0, 180 },
...
// "L"iches.
{
    ...
    MR_RES_COLD | mrd(MR_RES_ELEC, 2),
    0, 15, MONS_SKELETON, MONS_LICH, MH_UNDEAD, -11,
...
// Mara.
{
    ...
    M_SPELLCASTER | M_SEE_INVIS | M_SPEAKS,
    MR_RES_POISON | mrd(MR_RES_FIRE, 2),
    0, 20, MONS_ILLUSION, MONS_RAKSHASA_FAKE, MH_DEMONIC, -6,
    { {AT_HIT, AF_PLAIN, 30}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 18, 0, 0, 140 },
...
{
    MONS_SERPENT_OF_HELL, 'S', ETC_FIRE, "the Serpent of Hell",
    M_SPELLCASTER | M_SENSE_INVIS | M_UNIQUE | M_FAKE_SPELLS,
    MR_RES_POISON | MR_RES_HELLFIRE,
    0, 18, MONS_SERPENT, MONS_SERPENT_OF_HELL, MH_DEMONIC, -13,
    { {AT_BITE, AF_PLAIN, 35}, {AT_CLAW, AF_PLAIN, 15},
      {AT_TRAMPLE, AF_PLAIN, 15}, AT_NO_ATK },
    { 20, 4, 4, 0 },
    12, 9, MST_SERPENT_OF_HELL_GEHENNA, CE_CLEAN, Z_NOZOMBIE, S_ROAR,
    I_HIGH, HT_LAND, FL_FLY, 14, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_HUGE
},

{
    MONS_SERPENT_OF_HELL_COCYTUS, 'S', ETC_ICE, "the Serpent of Hell",
    M_SPELLCASTER | M_SENSE_INVIS | M_UNIQUE | M_FAKE_SPELLS,
    ...
    { {AT_BITE, AF_PLAIN, 35}, {AT_CLAW, AF_PLAIN, 15},
      {AT_TRAMPLE, AF_PLAIN, 15}, AT_NO_ATK },
    { 20, 4, 4, 0 },
    12, 9, MST_SERPENT_OF_HELL_COCYTUS, CE_CLEAN, Z_NOZOMBIE, S_ROAR,
    I_HIGH, HT_LAND, FL_FLY, 14, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_HUGE
},

{
    MONS_SERPENT_OF_HELL_DIS, 'S', ETC_IRON, "the Serpent of Hell",
    M_SPELLCASTER | M_SENSE_INVIS | M_UNIQUE | M_FAKE_SPELLS,
    MR_RES_POISON,
    0, 18, MONS_SERPENT, MONS_SERPENT_OF_HELL, MH_DEMONIC, -13,
    { {AT_BITE, AF_PLAIN, 35}, {AT_CLAW, AF_PLAIN, 15},
      {AT_TRAMPLE, AF_PLAIN, 15}, AT_NO_ATK },
    { 20, 4, 4, 0 },
    12, 9, MST_SERPENT_OF_HELL_DIS, CE_CLEAN, Z_NOZOMBIE, S_ROAR,
    I_HIGH, HT_LAND, FL_NONE, 14, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_HUGE
},

{
    MONS_SERPENT_OF_HELL_TARTARUS, 'S', ETC_DEATH, "the Serpent of Hell",
    M_SPELLCASTER | M_SENSE_INVIS | M_UNIQUE | M_FAKE_SPELLS,
    MR_RES_POISON,
    0, 18, MONS_SERPENT, MONS_SERPENT_OF_HELL, MH_DEMONIC, -13,
    { {AT_BITE, AF_PLAIN, 35}, {AT_CLAW, AF_PLAIN, 15},
      {AT_TRAMPLE, AF_PLAIN, 15}, AT_NO_ATK },
    { 20, 4, 4, 0 },
    12, 9, MST_SERPENT_OF_HELL_TARTARUS, CE_CLEAN, Z_NOZOMBIE, S_ROAR,
    I_HIGH, HT_LAND, FL_FLY, 14, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_HUGE
},
...
// Skulls and "z" undead.
{
    ...
    0, 15, MONS_SKELETON, MONS_CURSE_SKULL, MH_UNDEAD, MAG_IMMUNE,
...

{
    ...
    M_UNIQUE | M_SPELLCASTER | M_ACTUAL_SPELLS | M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    550, 125, MONS_ELF, MONS_HIGH_ELF, MH_NATURAL, -3,
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 1, 0, 0, 10 },
...

{
    ...
    M_UNIQUE | M_FIGHTER | M_SPELLCASTER | M_ACTUAL_SPELLS | M_WARM_BLOOD
        | M_SPEAKS,
    MR_NO_FLAGS,
    550, 20, MONS_BIRD, MONS_TENGU, MH_NATURAL, -5,
    { {AT_HIT, AF_PLAIN, 12}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 9, 0, 0, 76 },
...

{
    ...
    MR_NO_FLAGS,
    550, 10, MONS_HUMAN, MONS_DEMIGOD, MH_NATURAL, -5,
...

{
    ...
    M_UNIQUE | M_SPELLCASTER | M_ACTUAL_SPELLS | M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    550, 24, MONS_HUMAN, MONS_HALFLING, MH_NATURAL, -4,
