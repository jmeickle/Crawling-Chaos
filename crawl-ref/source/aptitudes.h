...
static const species_skill_aptitude species_skill_aptitudes[] =
{
    ...
    APT(SP_FELID,           SK_SHORT_BLADES,    0),
    APT(SP_FELID,           SK_LONG_BLADES,     0),
    APT(SP_FELID,           SK_AXES,            0),
    APT(SP_FELID,           SK_MACES_FLAILS,    0),
    APT(SP_FELID,           SK_POLEARMS,        0),
    APT(SP_FELID,           SK_STAVES,          0),
    APT(SP_FELID,           SK_SLINGS,          0),
    APT(SP_FELID,           SK_BOWS,            0),
    APT(SP_FELID,           SK_CROSSBOWS,       0),
    APT(SP_FELID,           SK_THROWING,        0),
    APT(SP_FELID,           SK_ARMOUR,          0),
    APT(SP_FELID,           SK_DODGING,         3),
    APT(SP_FELID,           SK_STEALTH,         3),
    APT(SP_FELID,           SK_STABBING,        3),
    APT(SP_FELID,           SK_SHIELDS,         0),
