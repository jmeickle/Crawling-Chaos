...
enum cap_desc_type
{
    ...
    TCAP_DESC_HAT,
    TCAP_DESC_COIF,
    TCAP_DESC_MAX_RARE = TCAP_DESC_CAP,
    TCAP_DESC_HOOD,
    TCAP_DESC_COWL,
...
enum wizard_hat_desc_type
{
    ...
    TWIZHAT_DESC_MITER,
    TWIZHAT_DESC_MAX_RARE = TWIZHAT_DESC_WIZARD_HAT,
...
enum helmet_desc_type
{
    ...
    THELM_DESC_PLUMED,
    THELM_DESC_VISORED,
    THELM_DESC_MAX_RARE = THELM_DESC_HELMET,
...
enum gloves_desc_type
{
    ...
    TGLOV_DESC_MAX_RARE = TGLOV_DESC_GLOVES,
    TGLOV_DESC_BRACERS,
    TGLOV_DESC_BRACELET,
    TGLOV_DESC_HANDWRAP,
    TGLOV_DESC_MITTENS,
...
enum cloak_desc_type
{
    ...
    TCLOAK_DESC_CAPE,
    TCLOAK_DESC_MANTLE,
    TCLOAK_DESC_MAX_RARE = TCLOAK_DESC_CLOAK,
    TCLOAK_DESC_SHAWL,
    TCLOAK_DESC_SCARF,
    TCLOAK_DESC_STOLE,
    TCLOAK_NUM_DESCS,
...
enum boot_desc_type
{
    ...
    TBOOT_DESC_MAX_RARE = TBOOT_DESC_BOOTS,
    TBOOT_DESC_GALOSHES,
