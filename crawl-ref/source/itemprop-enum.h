...
enum helmet_desc_type
{
    ...
    THELM_DESC_MAX_RARE = THELM_DESC_MAIL_COIF,
...
enum handwrap_desc_type
{
    ...
    THANDWRAP_DESC_WRISTBAND,
    THANDWRAP_DESC_MAX_RARE = THANDWRAP_DESC_WRISTBAND,
    THANDWRAP_DESC_BRACELET,
    THANDWRAP_DESC_BANGLE,
...
enum gloves_desc_type
{
    TGLOV_DESC_GLOVES = 0,
    TGLOV_DESC_BRACERS,
    TGLOV_DESC_MAX_RARE = TGLOV_DESC_BRACERS,
    TGLOV_DESC_MYRMEX,
    TGLOV_DESC_WEIGHTED_GLOVE,
    TGLOV_NUM_DESCS,
};

enum gauntlet_desc_type
{
    TGAUNTLET_DESC_GAUNTLETS = 0,
    TGAUNTLET_DESC_VAMBRACES,
    TGAUNTLET_DESC_MAX_RARE = TGAUNTLET_DESC_VAMBRACES,
    TGAUNTLET_DESC_CESTUS,
    TGAUNTLET_DESC_SPIKED_GAUNTLETS,
    TGAUNTLET_NUM_DESCS,
};
...
enum cloak_desc_type
{
    ...
    TCLOAK_DESC_MANTLE,
    TCLOAK_DESC_TABARD,
    TCLOAK_DESC_MAX_RARE = TCLOAK_DESC_TABARD,
    TCLOAK_DESC_SHAWL,
    TCLOAK_DESC_SCARF,
    TCLOAK_DESC_STOLE,
    TCLOAK_NUM_DESCS,
...
{
    TFOOTWRAP_DESC_FOOTWRAP = 0,
    TFOOTWRAP_DESC_SANDALS,
    TFOOTWRAP_DESC_MAX_RARE = TFOOTWRAP_DESC_SANDALS,
...
enum shoe_desc_type
{
    ...
    TSHOE_DESC_MAX_RARE = TSHOE_DESC_MOCCASINS,
    TSHOE_DESC_GALOSHES,
    TSHOE_DESC_LOAFERS,
    TSHOE_NUM_DESCS,
};
...
{
    TBOOT_DESC_BOOTS = 0,
    TBOOT_DESC_HIKING_BOOTS,
    TBOOT_DESC_MAX_RARE = TBOOT_DESC_HIKING_BOOTS
    TBOOT_DESC_CLOGS
