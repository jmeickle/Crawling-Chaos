...
enum cap_desc_type
{
    ...
    TCAP_DESC_HAT,
    TCAP_DESC_COIF,
    TCAP_DESC_MAX_RARE = TCAP_DESC_COIF,
    TCAP_DESC_HOOD,
    TCAP_DESC_COWL,
    TCAP_DESC_FEATHERED_CAP,
    TCAP_DESC_PEAKED_CAP,
    TCAP_DESC_FEDORA,
    TCAP_DESC_FEZ,
    TCAP_DESC_BANDANA,
    TCAP_DESC_SOMBRERO,
...
enum wizard_hat_desc_type
{
    TWIZHAT_DESC_WIZARD_HAT = 0,
    TWIZHAT_DESC_TURBAN,
    TWIZHAT_DESC_SKULLCAP,
    TWIZHAT_DESC_MITER,
    TWIZHAT_DESC_MAX_RARE = TWIZHAT_DESC_MITER,
    TWIZHAT_DESC_DUNCE_CAP,
    TWIZHAT_DESC_VEIL,
    TWIZHAT_DESC_MASK,
    TWIZHAT_NUM_DESCS
};
...
enum helmet_desc_type
{
    ...
    THELM_DESC_PLUMED,
    THELM_DESC_VISORED,
    THELM_DESC_MAIL_COIF,
    THELM_DESC_MAX_RARE = THELM_DESC_VISORED,
    THELM_DESC_GREATHELM,
    THELM_DESC_WINGED,
    THELM_DESC_SPIKED,
    THELM_DESC_GOLDEN,
    THELM_DESC_CROWN,
...
enum handwrap_desc_type
{
    
BANGLE
    THANDWRAP_DESC_HANDWRAP = 0,
    THANDWRAP_DESC_GAUNTLETS,
    THANDWRAP_DESC_MAX_RARE = THANDWRAP_DESC_GAUNTLETS,
    THANDWRAP_DESC_BRACERS,
    THANDWRAP_DESC_BRACELET,
    THANDWRAP_DESC_HANDWRAP,
    THANDWRAP_DESC_MITTENS,
    THANDWRAP_NUM_DESCS,
};
...
enum gloves_desc_type
{
    ...
    TGLOV_DESC_MAX_RARE = TGLOV_DESC_GAUNTLETS,
    TGLOV_DESC_BRACERS,
    TGLOV_DESC_BRACELET,
    TGLOV_DESC_HANDWRAP,
    TGLOV_DESC_MITTENS,
...
enum gauntlet_desc_type
{
    VAMBRACES
TGAUNTLET_DESC_GLOVES = 0,
    TGAUNTLET_DESC_GAUNTLETS,
    TGAUNTLET_DESC_MAX_RARE = TGAUNTLET_DESC_GAUNTLETS,
    TGAUNTLET_DESC_BRACERS,
    TGAUNTLET_DESC_BRACELET,
    TGAUNTLET_DESC_HANDWRAP,
    TGAUNTLET_DESC_MITTENS,
    TGAUNTLET_NUM_DESCS,
};


enum cloak_desc_type
{
TABARD
    TCLOAK_DESC_CLOAK = 0,
    TCLOAK_DESC_CAPE,
    TCLOAK_DESC_MANTLE,
    TCLOAK_DESC_MAX_RARE = TCLOAK_DESC_MANTLE,
    TCLOAK_DESC_SHAWL,
    TCLOAK_DESC_SCARF,
    TCLOAK_DESC_STOLE,
    TCLOAK_NUM_DESCS,
...
enum footwrap_desc_type
{
    TFOOTWRAP_DESC_BOOTS = 0,
    TFOOTWRAP_DESC_SHOES,
    TFOOTWRAP_DESC_SANDALS,
    TFOOTWRAP_DESC_SOLLERETS,
    TFOOTWRAP_DESC_MAX_RARE = TFOOTWRAP_DESC_SOLLERETS,
    TFOOTWRAP_DESC_GALOSHES,
    TFOOTWRAP_DESC_MOCCASINS,
    TFOOTWRAP_DESC_LOAFERS,
    TFOOTWRAP_DESC_SLIPPERS,
    TFOOTWRAP_DESC_FOOTWRAP,
    TFOOTWRAP_DESC_ANKLET,
    TFOOTWRAP_NUM_DESCS,
...
enum shoe_desc_type
{
    ...
    TSHOE_DESC_SHOES,
    TSHOE_DESC_SANDALS,
    TSHOE_DESC_SOLLERETS,
    TSHOE_DESC_MAX_RARE = TSHOE_DESC_SOLLERETS,
    TSHOE_DESC_GALOSHES,
    TSHOE_DESC_MOCCASINS,
    TSHOE_DESC_LOAFERS,
    TSHOE_DESC_SLIPPERS,
    TSHOE_DESC_FOOTWRAP,
    TSHOE_DESC_ANKLET,
...
enum boot_desc_type
{
    ...
    TBOOT_DESC_SHOES,
    TBOOT_DESC_SANDALS,
    TBOOT_DESC_SOLLERETS,
    TBOOT_DESC_MAX_RARE = TBOOT_DESC_SOLLERETS,
    TBOOT_DESC_GALOSHES,
    TBOOT_DESC_MOCCASINS,
    TBOOT_DESC_LOAFERS,
    TBOOT_DESC_SLIPPERS,
    TBOOT_DESC_FOOTWRAP,
    TBOOT_DESC_ANKLET,
